...
ar: {
    ...
    'dashboard.dupReason': '⚠️ تقرير مكرر: نفس رقم الجوال وتاريخ التقرير وحالة التقرير مع {n} تقرير آخر بالجدول، بمطابقة في {match}.',
...
en: {
    ...
    'dashboard.dupReason': '⚠️ Duplicate report: same phone number, report date, and status as {n} other report(s) in the table, matching by {match}.',
